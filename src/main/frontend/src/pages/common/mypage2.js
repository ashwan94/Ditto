                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="py-5">
                            ...
                            <span onClick={() => setShowBook(false)}
                                  className="btn mt-1 text-lg leading-6 text-gray-600">내 정보 보기</span>
                            {/* 도서 대출 이력 보기 */}
                            <span onClick={() => setShowBook(true)}
                                  className="btn mt-1 text-lg leading-6 text-gray-600 mx-3">도서 대출 이력 보기</span>
                        </div>
                        {showBook ? (
                            <div
