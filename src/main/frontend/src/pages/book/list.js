...
export default function BookList() {
  ...
  const changePage =  () => {
      ...
      //     pageBtn.innerHTML += `<a href="/book/list?currentPageNo=${i}"
      //   class="pageNumber" id="page_${i}" onclick=" 여기에 함수 못넣나요ㅠ .. 함수로 setCurrentPage해버리고 싶습니다 . . .">${i}</a>`
      // }
      console.log("버튼 클릭 후 현재 페이지 상태", currentPage);
  }
