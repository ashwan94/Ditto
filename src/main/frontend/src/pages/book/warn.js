            ...
            <section className="gj do hj sp jr i pg rundry">
                <div className="bb ze ki xn 2xl:ud-px-0">
                    <div className="container">
                        <img
                            src="https://cdn-optimized.imweb.me/upload/S202009296de27cb1ff0a8/a7fe567e826eb.jpg?w=1920"
                            alt="Example"
                            style={{
                                width: '100%',
                                height: '300px',
                        ...
                        <table className="board-table mt-5" style={{fontSize: "20px"}}>
                            ...
                            <td style={{
                                display: "flex", justifyContent: "center", alignItems: "center", background: "lightgray"
                            }}>
                                내용
