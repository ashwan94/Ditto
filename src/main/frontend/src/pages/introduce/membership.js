...
import KakaoTalk from "../common/kakaoTalk";
            ...
            <div className="gj do ir hj sp jr i pg rundry">
                ...
                <section className="gj do ir hj sp jr i pg">
                    <div className="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r me-36">
                        ...
                        <img src="https://cdn.wadiz.kr/ft/images/green001/2021/0702/20210702193533979_7.gif" alt="library" className="rounded-3xl my-52"
                        style ={{width:"100%", height:"80%"}}/>
                    </div>
                    <div className="bb ze ki xn 2xl:ud-px-0 mt-32">
                        <div className="tc _o">
                            <div className="animate_left jn/2">
                                <h1 className="fk vj zp or kk wm wbss font-extrabold rundry px-2 py-3" style={{fontSize:"65px"}}>
                                    나와 너, 그리고 우리를<br /> 위한 공간
                                </h1>
                                <p className="fq mt-2">
                                    생각은 곱씹으면 깊어지고, 아이디어는 부딪힐수록 커집니다.<br /> 한석줍쇼에서는 사람과 사람을 연결하는<br /> 커뮤니케이션 공간을 제공하며,<br /> 많은 사람들이 반짝이는
                                ...
                                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-blue-gray-900 capitalize"> 하루 체험판 </h5>
                                            <p className="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500"> 한석줍쇼의 분위기를 파악하고 싶은 당신에게 추천하는 1일 패키지</p>
                                            <h3 className="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">$9.99<span
                                            ...
                                            <ul className="flex flex-col gap-3">
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         ...
                                                         aria-hidden="true" className="h-4 w-4 text-blue-gray-900">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                              d="M4.5 12.75l6 6 9-13.5"></path>
                                                    </svg>
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">카페테리아
                                                        이용 가능</p>
                                                </li>
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">무료
                                                        와이파이 이용 가능</p>
                                                </li>
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                ...
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">개인석 이용 가능</p>
                                                </li>
                                            </ul>
                                            <button
                                    ...
                                    <div
                                            className="relative bg-clip-border mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none !m-0 p-6">
                                            <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-blue-gray-900 capitalize">한달 이용권</h5>
                                            <p className="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500">꾸준히 자기계발을 하고 싶은 당신에게 추천하는 한석줍쇼 한달 이용권</p>
                                            <h3 className="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">$29.99<span
                                                className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                                            </h3>
                                        </div>
                                        <div className="p-6 border-t border-blue-gray-50">
                                            <ul className="flex flex-col gap-3">
                                                ...
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">도서 대여 가능</p>
                                                </li>
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="relative bg-clip-border mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none !m-0 p-6">
                                            <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-blue-gray-900 capitalize">기업체 공유오피스 입주 상담</h5>
                                            <p className="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500"> 높은 사옥 이전 비용, 인테리어 비용이 부담스러운 사장님들께 추천하는 입주 상담 서비스</p>
                                            <h3 className="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">Contact
                                                us<span
                                                    className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                                            </h3>
                                        </div>
                                        <div className="p-6 border-t border-blue-gray-50">
                                            <ul className="flex flex-col gap-3">
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">24시간 입주 상담 예약 가능</p>
                                                </li>
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">아래 톡상담 버튼을 클릭해주세요</p>
                                                </li>
                                                <li className="flex items-center gap-3 text-gray-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                                    ...
                                                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-inherit">혹은 010-4795-9464로 문의주시면<br /> 빠른 응답드리겠습니다 </p>
                                                </li>
                                            </ul>
                                            <button
                                                className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-2 px-4 rounded-lg border border-green-500 text-green-500 hover:opacity-75 focus:ring focus:ring-green-200 active:opacity-[0.85] block w-full mt-6"
                                                type="button"
                                            onClick={()=>{const kakaoTalk = document.querySelector("#chat-channel-button")
                                            kakaoTalk.click()}}>상담하기
                                            </button>
                                        </div>
                                    </div>
                                </div>
