        ...
        <section className="gj do hj sp jr i pg rundry">
            <div className="bb ze ki xn 2xl:ud-px-0 mb-8" style={{borderTop: "1px solid lightgray"}}>
                ...
                <div className="bb ze ki xn 2xl:ud-px-0 mb-8" style={{borderTop: "1px solid lightgray"}} />
                        ...
                        <div style={{backgroundColor:"lightblue", padding:"5%"}} className="rounded-xl">
                    <div style={{display: "inline-flex", alignItems: "flex-start", margin: "auto"}}>
                        {/* FAQ 좌측 이미지 */}
                            <p style={{color:"white", fontSize:"50px", display: "inline-flex", alignItems: "flex-start", margin: "auto"}}>한석줍쇼에게 궁금한 점</p> </div>
                        {/* FAQ 질문 모음 */}
                            <ul className="max-w-4xl mx-3 divide-y shadow shadow-blue-900 rounded-xl ml-32 mt-10">
                                <li>
                                    <details className="group">
                                        <summary
                                            ...
                                            <span style={{backgroundColor: "white", padding: "1%"}}
                                                  className="rounded-xl">보증금이 너무 저렴해서 의심스러워요</span>
                                        </summary>

                                        <article className="px-4 pb-4">
                                            <p style={{backgroundColor: "white", padding: "1%"}} className="rounded-xl">
                                                NO! 보증금은 원래 비싸지 않아도 괜찮아요.<br/>
                                ...
                                <li>
                                    <details className="group">
                                        ...
                                        <article className="px-4 pb-4">
                                            <p style={{backgroundColor: "white", padding: "1%"}} className="rounded-xl">
                                                NO! 패파는 한석줍쇼 회원증 카드로 출입이 가능해요.<br/>
                                ...
                                <li>
                                    <details className="group">
                                        ...
                                        <article className="px-4 pb-4">
                                            <p style={{backgroundColor: "white", padding: "1%"}} className="rounded-xl">
                                                NO! 한석줍쇼는 24시간 냉난방 가동을 멈추지 않아요.<br/>
